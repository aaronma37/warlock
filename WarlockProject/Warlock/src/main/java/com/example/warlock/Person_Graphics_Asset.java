...
//"gl_FragColor = vColor;" +
    ...
    public Person_Graphics_Asset(final Context activityContext, int k, float i_AR, float i_size, float x_1, float x_2, float y_1, float y_2, Motion_Model_2 i_model)
    {
