...
public class Projectile_Graphics_Asset
{
...
*/
    ...
    public Projectile_Graphics_Asset(final Context activityContext, int k, float i_AR, float i_size, float i_x_off, float i_y_off, float a_1, float a_2, float a_3, float a_4, float a_5, float i_mass, float i_drag)
    {
        AR=i_AR;
        size=i_size;
        x_off=i_x_off;
